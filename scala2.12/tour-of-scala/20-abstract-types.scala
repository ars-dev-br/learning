object AbstractTypes extends App {
  ...
  // there are cases in which it's impossible to replace abstract types with
  // parameters.  happily, this isn't one of those:
  ...
  def newIntSeqBuf2(elem1: Int, elem2: Int): SeqBuffer2[Int, Seq[Int]] =
